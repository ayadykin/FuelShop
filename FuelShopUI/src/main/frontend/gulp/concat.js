...
module.exports = function() {
	...
	concatMainModule : function() {
	    var path = getModuleTree('shop');

	    path.push('js/shop/controllers/**/*.js');
	   ...
	   // path.push('../webapp/js/friend/controllers/build/app.js', '../webapp/js/group/controllers/build/app.js',
	    ...
	    return gulp.src(path).pipe(concat('app.js')).pipe(gulp.dest('../webapp/js/shop/build/'));
